          ...
          child: Card(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: pokemon.weaknesses.map((t)=>FilterChip(backgroundColor:Colors.deepOrangeAccent
  ,label: Text(t), onSelected: (b){})).toList(),
                ),
                ...
                Row(
                  ...
                  pokemon.nextEvolution?.map
                    ((t)=>FilterChip(backgroundColor:Colors.greenAccent ,
                      label: Text(t.name), onSelected: (b){} ))?.toList()??[Text("No more evolutions")],
                ),
